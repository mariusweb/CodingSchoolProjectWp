...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
		...
		// assets/scripts/jquery.fancybox.min.js
...
function theme_stylesheets(){
	...
	if( defined('ASSETS_URL') ) {
		...
		//Registration
		wp_register_style('icon', ASSETS_URL . '/assets/icon/icomoon/style.css', array(), false, 'all');
		wp_register_style('font', ASSETS_URL . '/assets/font/stylesheet.css', array('icon'), false, 'all');
		wp_register_style('main-css', ASSETS_URL . '/assets/css/style.css', array('font'), false, 'all');
		wp_register_style('owl-carousel', ASSETS_URL . '/assets/css/owl.carousel.css', array('main-css'), false, 'all');
